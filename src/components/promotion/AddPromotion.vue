  ...
  <div class="main">
    ...
    <div class="align-content-center">
      <validation-observer v-slot="{ handleSubmit }">
        <form @submit.stop.prevent="handleSubmit(addPromotion)">
...
export default {
  ...
  methods: {
    ...
    addPromotion() {
      let data = {
        previousDesignation: this.promotion.previousDesignation,
        newDesignation: this.promotion.newDesignation,
        promotionDate: this.promotion.promotionDate,
        ippis: this.$store.state.ippis
      };

      PromotionService.createPromotion(data).then(() => {
