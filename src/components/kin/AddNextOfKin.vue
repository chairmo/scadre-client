  ...
  <div class="main">
    ...
    <div class="align-content-center">
      <validation-observer v-slot="{ handleSubmit }">
        <form @submit.stop.prevent="handleSubmit(addNextOfKin)">
            ...
            <div class="col-xl-4">
              <validation-provider name="Phone Number" :rules="{required: true, digits: 10}"
                ...
                <input name="Phone Number" type="tel" :state="getValidateState(validationContext)"
                       aria-describedby="input-1-live-feedback"
                       v-model="kin.phoneNumber" placeholder="Enter phone" class="form-control"/>
                {{ validationContext.errors[0] }}
              </validation-provider>
            </div>
