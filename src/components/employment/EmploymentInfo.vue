  ...
  <div class="main">
    <div class="card">
      ...
      <a v-if="!employment.id" style="text-align: center">
        <router-link :to="{name:'addEmployment'}" class="btn btn-success">Add Employment Info</router-link>
      </a>
      <div class="btn btn-group" v-if="employment.id">
        <router-link :to="{name:'editEmployment', params:{id:employment.id}}" class="btn btn-success">Update
        </router-link>
        <router-link :to="{name:'historyInfo'}" class="btn btn-success">Next
        </router-link>
