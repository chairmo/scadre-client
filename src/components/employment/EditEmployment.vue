  ...
  <div class="main">
    ...
    <div class="align-content-center">
      <validation-observer v-slot="{ handleSubmit }">
        <form @submit.stop.prevent="handleSubmit(updateEmployment)">
...
export default {
  ...
  methods: {
    ...
    fetchEmployment() {
      EmploymentService.retrieveEmployment(this.$route.params.id).then((res) => {
        this.employment = res.data;
      })
    },
    updateEmployment() {
      EmploymentService.updateEmployment(this.$route.params.id, this.employment).then(() => {
