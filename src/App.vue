<template>
  <div>
    <nav>
      <div v-if="!authenticated" v-cloak>
        <header>
          <!-- Navbar -->
            ...
            <div class="container">
              ...
              <nav class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto smooth-scroll">
                  ...
                  <li class="nav-item" style="margin-right: 340px">
      ...
      <nav v-if="authenticated">
        <nav class="col-md-12 mb-4 white-text text-center navbar navbar-expand-md navbar-light small-size"
             style="padding-top: 5px; background:#007d53;">
          <div class="collapse navbar-collapse" style="margin: 5px 0 5px 5px">
            <a><img src="./assets/logo.png" alt="50%" height="90" width="90"></a>
            <span class="display-7 font-weight-bold white-text mb-2 pt-md-3 pt-3 navbar-centre">
             FEDERAL MINISTRY OF COMMUNICATIONS AND DIGITAL ECONOMY</span>
          </div>
          <ul class="navbar-nav">
  ...
  methods: {
    ...
    async isAuthenticated() {
      ...
      await this.$auth.getUser().then(user => {
        ...
        this.$store.commit('setIppis', user.ippisNumber)
